...
class DSD100(Dataset):
    ...
    def __init__(
        ...
        # DSD100 folder structure:
        # root_dir / Mixtures / (Dev/Test)
        # root_dir / Sources  / (Dev/Test)
    ...
    def __getitem__(self, idx):
        ...
        # Return in shape [1, freq, time] (add channel dim)
        return (
    ...
    def _adjust_length(self, spectrogram):
        """
        Ensure time dimension uses the same formula as MUSDB18:
          desired_time_dim = (max_length_seconds * sr - n_fft) // hop_length + 1
        """
